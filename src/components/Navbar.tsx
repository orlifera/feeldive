    ...
    backdrop-blur-xl flex flex-row justify-between items-center p-4">
                    ...
                    <div id="links" className="text-center text-lg font-medium flex items-center">
                        <ul className="flex flex-row justify-between items-center gap-4 text-md">
                            <li>
                                <Link href='/' className={`cursor-pointer ${isActive('/') ? 'font-extrabold border-b-1 border-primary p-4 cursor-default w-full' : ''}`} >Home</Link>
                            </li>
                            <li><Link href='/about' className={`cursor-pointer ${isActive('/about') ? 'font-extrabold border-b-1 border-primary p-4 cursor-default w-full' : ''}`}>Chi Siamo</Link></li>
                            <li>
                                <ServiceDropDown />
                            </li>
                            <li>
                                <Link href='/gallery' className={`cursor-pointer ${isActive('/gallery') ? 'font-extrabold border-b-1 border-primary p-4 cursor-default w-full' : ''}`}>Gallery</Link>
                            </li>
                            <li>
                                <Link href='/contatti' className={`cursor-pointer ${isActive('/contatti') ? 'font-extrabold border-b-1 border-primary p-4 cursor-default w-full' : ''}`}>Contatti</Link>
